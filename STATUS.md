...
**Last verified:** 2026-06-17 (self-serve operator onboarding wizard hidden — concierge model) · **Branch:** `feature/hide-operator-self-serve` (PR → `dev`) · **App:** Next.js 15.5 / React 19 / Supabase / Prisma
